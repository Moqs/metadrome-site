  ...
  <div>
    <div style={{display:"flex",
      ...
      <figure className="image" style={{marginBottom:"0"}}>
        <img src={logo} alt="Metadrome" style={{ width: '5rem', marginTop:"0rem", marginBottom:"0", marginLeft:"0", marginRight:"2rem", flexGrow:"5"}} />
      </figure>
      <h1 style={{ color:"#F33535" ,fontSize:"5rem",fontFamily: ['Oleo Script', 'Segoe UI', 'sans-serif'], flexGrow:"5" }}>Metadrome</h1>
    </div>
